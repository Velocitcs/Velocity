...
import { Forms, RunningGameStore, showToast, TextInput, Toasts, Tooltip, useEffect, useState } from "@webpack/common";
    ...
    patches: [
        ...
        // FIXME(Bundler minifier change related): Remove the non used compability once enough time has passed
        {
            ...
            replacement: {
                // let { ... nowPlaying: a = !1 ...
                // let { overlay: b ... } = Props
                match: /return\s*\(0,r\.jsxs\)\(r\.Fragment,\{children:\[\(0,r\.jsxs\)\("div"/,
                replace: m => "return (0,r.jsxs)(r.Fragment,{children:[$self.renderToggleGameActivityButton(S,a),(0,r.jsxs)(\"div\"",
                noWarn: true,
            }
        },
        {
