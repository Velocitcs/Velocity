...
import { OnlineStatus, Platform, User } from "@velocity-types";
...
const Icons: Record<Platform, IconData> = {
...
const PlatformIcon = ({ platform, status, small }: { platform: Platform, status: OnlineStatus; small: boolean; }) => {
...
function getBadges({ userId }: BadgeUserArgs): ProfileBadge[] {
    ...
    return Object.entries(status).map(([platform, status]) => {
        ...
        const icon = Icons[platform as Platform] ?? Icons.desktop;
