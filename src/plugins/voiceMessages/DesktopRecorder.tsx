...
const Native = VelocityNative.pluginHelpers.VoiceMessages as PluginNative<typeof import("./native")>;
        ...
        if (nowRecording) {
            ...
            discordVoice.stopLocalAudioRecording(async (filePath: string) => {
                if (filePath) {
                    ...
                    if (buf)
                        setAudioBlob(new Blob([buf.buffer.slice(0) as ArrayBuffer], { type: "audio/ogg; codecs=opus" }));
                    else
