...
export function ChromeIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-chrome-icon")}
            viewBox="0 0 512 512"
        >
...
export function EdgeIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-edge-icon")}
            viewBox="0 0 24 24"
        >
...
export function FirefoxIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-firefox-icon")}
            viewBox="0 0 512 512"
        >
...
export function IEIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-ie-icon")}
            viewBox="0 0 512 512"
        >
...
export function OperaIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-opera-icon")}
            viewBox="0 0 496 512"
        >
...
export function SafariIcon(props: IconProps) {
    return (
        <Icon
            {...props}
            className={classes(props.className, "vc-safari-icon")}
            viewBox="0 0 512 512"
        >
